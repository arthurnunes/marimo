...
def _(__file__, mo):
    mo.md(
        ...
        !!! tip "This notebook is best viewed as an app."
            ...
            or hit CmdCtrl+.Cmd/Ctrl+. or click the "app view" button in the bottom right.
        """
    )
    return
...
def _(mo):
    mo.md(
        ...
        Next we will toggle to "App view" (hit CmdCtrl+.Cmd/Ctrl+. or click the "app view") in order to layout our dashboard with the grid layout editor.
        """
    )
    return
